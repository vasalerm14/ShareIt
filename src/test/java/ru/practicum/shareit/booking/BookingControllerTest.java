...
class BookingControllerTest {
    ...
    private final BookingDtoOut bookingDtoOut = new BookingDtoOut(
            ...
            LocalDateTime.now().plusDays(1),
            LocalDateTime.now().plusDays(2),
            new ItemDtoShort(1, "item"),
            new UserDtoShort(1, "user"),
            null);

    @Test
    void saveNewBooking() throws Exception {
        when(bookingService.saveNewBooking(any(), anyInt())).thenReturn(bookingDtoOut);
    ...
    void approve() throws Exception {
        when(bookingService.approve(anyInt(), any(), anyInt())).thenReturn(bookingDtoOut);
    ...
    void getAllByBooker() throws Exception {
        when(bookingService.getAllByBooker(anyInt(), anyInt(), anyString(), anyInt()))
    ...
    void getAllByOwner() throws Exception {
        when(bookingService.getAllByOwner(anyInt(), anyInt(), anyString(), anyInt()))
                .thenReturn(List.of(bookingDtoOut));
